        ...
        <form action="{{ route('vehicles.update', $vehicle) }}" method="POST" novalidate>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="chassis_number" id="chassis_number"
                           ...
                           value="{{ old('chassis_number', $vehicle->chassis_number) }}" autofocus>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="manufacture_company" id="manufacture_company"
                           ...
                           value="{{ old('manufacture_company', $vehicle->manufacture_company) }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="manufacture_year" id="manufacture_year"
                           ...
                           value="{{ old('manufacture_year', $vehicle->manufacture_year) }}" min="1900" max="{{ date('Y') }}">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-floppy-disk"></i> Update Vehicle
                </button>
